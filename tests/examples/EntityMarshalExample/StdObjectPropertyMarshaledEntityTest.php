...
class StdObjectPropertyMarshaledEntityTest extends \PHPUnit_Framework_TestCase
{
     ...
     */
    public function testSetNonExistant()
    {
        $this->object->testNotExists = 'anything';
    }
    ...
    public function testFromArray()
    {
        ...
        $data['testEntityMarshal'] = $this->getSampleDataArray();
        $data['testStdClass']      = $this->getSampleDataArray();
        $data['testObject']        = $this->getSampleDataArray();

        $data['testNotExists']     = 'anything';
    ...
    public function testGetter()
    {
        ...
        $expected = $data['testString'];
        $actual   = $this->object->get('testString');
    ...
    public function testIsset()
    {
        ...
        $this->assertTrue(isset($this->object->testString));
    }
    ...
    {
        unset($this->object->testString);

        $this->assertFalse(isset($this->object->testString));
    }
