...
abstract class DataObject extends Cloneable implements Iterator, Serializable
{
    ...
    final public static function ImportCache($cache)
    {
        ...
        if ($unserialize === false) {
            throw new DataObjectException(sprintf(self::$exceptions[11], $cache, __METHOD__), 11);
        }
    ...
    public function unserialize($serialized)
    {
        ...
        if ($unserialized === false) {
            throw new DataObjectException(sprintf(self::$exceptions[11], $serialized, __METHOD__), 11);
        }
